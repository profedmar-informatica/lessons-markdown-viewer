...
const Sidebar = () => {
    ...
    return (
      <>
        ...
        <Sheet open={sheetOpen} onOpenChange={setSheetOpen}>
          <SheetContent 
            side="left" 
            className="p-0 w-64 h-screen flex flex-col bg-panel-white border border-[#E0D8C7] shadow-[0_5px_15px_rgba(0,0,0,0.15),0_0_0_1px_rgba(0,0,0,0.05)] rounded-lg z-50
  ...
  return (
    <aside 
      className="w-64 h-screen flex flex-col bg-panel-white p-4 border border-[#E0D8C7] shadow-[0_5px_15px_rgba(0,0,0,0.15),0_0_0_1px_rgba(0,0,0,0.05)] rounded-lg z-50
                 dark:bg-vscode-bg-sidebar dark:border dark:border-vscode-border-sidebar dark:shadow-[0_10px_30px_rgba(0,0,0,0.5)]"
    >
      {sidebarHeader}
      <div className="flex justify-center -my-4"> {/* Margem negativa para compensar o espaço */}
