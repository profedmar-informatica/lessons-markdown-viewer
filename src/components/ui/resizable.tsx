...
// Omitimos 'ref' de BasePanelResizeHandleProps porque forwardRef já o fornece separadamente.
interface ResizableHandleProps extends Omit<BasePanelResizeHandleProps, 'ref'> {
  withHandle?: boolean;
}
...
>(({ className, withHandle, ...props }, ref) => {
  return (
    <PanelResizeHandle
      ...
      {...props} // Passa as demais props (que não incluem 'ref')
    >
      {withHandle && (
